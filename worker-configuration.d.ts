/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=Bindings` (hash: b1c5bb9a25a6600f9b2beaaaa2e9cf27)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "Session" | "db" | "signUpType" | "LILYPOND_SERVICE_URL" | "LILYPOND_API_KEY" | "LILYPOND_TIMEOUT_MS" | "EMAIL_SEND_URL" | "EMAIL_SEND_CODE" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "PO_APP_ID" | "PO_USER_ID" | "ALTERNATE_ORIGIN" | "NODE_ENV" | "BETTER_AUTH_SECRET" | "ENABLE_TEST_ROUTES" | "SIGN_UP_MODE">> {}
}
